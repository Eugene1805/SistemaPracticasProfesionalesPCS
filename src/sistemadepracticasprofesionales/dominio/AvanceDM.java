...
public class AvanceDM {
        ...
        try {
            ...
            resultado.setMensaje("Lo sentimos, no hay ninguna entrega registrada en el sistema para el Periodo Escolar actual, vuelvalo a intentar cuando ya las haya.");
