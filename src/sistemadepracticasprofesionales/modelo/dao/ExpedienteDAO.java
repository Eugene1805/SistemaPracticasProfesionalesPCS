...
public class ExpedienteDAO {
    ...
    public static List<Integer> obtenerIdsExpedientesActivosPorPeriodo(int idPeriodoEscolar) throws SQLException {
        List<Integer> ids = new ArrayList<>();
        Connection conexionBD = ConexionBD.abrirConexion();
        if (conexionBD != null) {
            String consulta = "SELECT id_expediente FROM expediente WHERE id_periodo_escolar = ? AND estado = 'Activo'";    
    ...
    public static Expediente obtenerExpedienteActivoPorEstudiante(int idEstudiante) throws SQLException {
        ...
        if (conexionBD != null) {
            String consulta = "SELECT id_expediente, horas_acomuladas, calificacion_documento, calificacion_evaluacion, calificacion_evaluacion_organizacion_vinculada, " +
                              "calificacion_total, estado, id_periodo_escolar, id_evaluacion_organizacion, id_estudiante FROM expediente WHERE id_estudiante = ? AND estado = 'Activo'";
